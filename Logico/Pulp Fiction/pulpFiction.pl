...
/*7. hartoDe/2: un personaje está harto de otro, cuando todas las tareas asignadas al primero 
...
requiereInteractuarConOtroPersonaje(Tarea, OtroPersonaje) :-
    amigo(OtroPersonaje, Amigo),
    requiereInteractuarConOtroPersonaje(Tarea, Amigo).
